...
export class EvidenceComponent {
	...
	public isActive = (evidence: EEvidence): boolean => this.selectedEvidences().includes(evidence);
	...
	public isIndeterminate = (evidence: EEvidence): boolean => this.excludedEvidences().includes(evidence);

	// Toggle the evidence based on the event (shift key for excluding evidence)
	public toggle = (evidence: EEvidence, event: MouseEvent): void => {
		if (event.shiftKey) {
	...
	private toggleExcludedEvidence = (evidence: EEvidence): void => {
	...
	private toggleSelectedEvidence = (evidence: EEvidence): void => {
